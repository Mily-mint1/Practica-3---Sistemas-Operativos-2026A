...
Una vez compilado el programa, se ejecuta en la terminal y se muestra la fecha actual, que es el 
resultado del comando `date` ejecutado por el proceso hijo.

![](../Imagenes/ejec.png){fig-align="center" width="400x"}
